...
export default class PhotoScaleDown extends BaseSection {
  ...
  update(scrollY: number): void {
    ...
    const scaleDownImgHeightPercent = this.scaleDownImgHeightStartingValue - (yPercent/100 * (-(this.scaleDownImgHeightEndingValue - this.scaleDownImgHeightStartingValue)));
